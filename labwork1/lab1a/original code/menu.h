...
void demo() {
	...
	st.add(p4);
	st.add(p5);
	Polynom p6 = sum(p1.lead, p2.lead);
	Polynom p7 = multi(p3.lead, p3.lead);
	Division d = div(p4, p5);
	Polynom quo = d.quotient;
	Polynom rem = d.remainder;
